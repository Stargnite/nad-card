...
// import { getWalletAge } from "@/lib/profile";
...
export default function Home() {
  ...
  useEffect(() => {
    const fetchTxCount = async () => {
      ...
      // const accountAge = await getWalletAge(account.address);
      console.log(txCount)
      ...
      setProfileData({
        ...
        accountAge: 10,
        // accountAge ?? 0,
        nftCount: Math.floor(Math.random() * 50) + 5, // placeholder
      });
...
//       if (txCount !== null) {
//         setProfileData({
//           transactionCount: txCount, // Math.floor(Math.random() * 1000) + 50,
